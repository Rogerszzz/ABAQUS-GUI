...
class materialcheck_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.mattableKw.setColumnType(7, AFXTABLE_TYPE_FLOAT)
        self.mattableKw.setColumnType(8, AFXTABLE_TYPE_FLOAT)
        self.mattableKw.setColumnType(9, AFXTABLE_TYPE_FLOAT)
        self.searchnameKw = AFXStringKeyword(self.cmd, 'searchname', True, '')

    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def getFirstDialog(self):

        import materialcheckDB
        return materialcheckDB.materialcheckDB(self)
